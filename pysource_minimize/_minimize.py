...
from ._minimize_base import py310
from ._minimize_base import py311
from ._minimize_base import py38
from ._minimize_base import until_py37
from ._minimize_base import ValueWrapper
from ._utils import unparse


class Minimizer(MinimizeBase):
    def minimize(self, o):
        if (
